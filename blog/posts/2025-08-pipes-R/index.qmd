...
date: "2025-07-16"
categories: ["data-science", "R", "pipes"]
...
Agora que você entende a intuição matemática por trás dos pipes, é hora de descobrir qual pipe usar em cada situação!

-   **Post anterior**: [Definindo objetos no R](../2025-07-definindo-objetos/) - Fundamentos sobre operadores de atribuição
-   **Próximo post**: [Pipes no R: qual usar?](../2025-08-pipes-qual-usar/) - Comparação prática entre `|>` e `%>%`

### Para se aprofundar

**Sobre programação funcional em R:** - [Functional Programming](https://adv-r.hadley.nz/fp.html) - Capítulo do Advanced R sobre programação funcional - [purrr tutorial](https://jennybc.github.io/purrr-tutorial/) - Programação funcional com purrr

**Conecte pipes com tidyverse:** - [Tidyverse: o melhor caminho para começar?](../2025-08-tidyverse-aprendendo/) - Se vale a pena começar com tidyverse - [A filosofia do Tidyverse](../2025-08-tidyverse-filosofia/) - Como pipes se encaixam na filosofia tidyverse
