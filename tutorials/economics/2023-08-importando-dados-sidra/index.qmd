...
```{r resp-nb-table, echo = FALSE}
respnb <- readRDS(here::here("static/data/tutorials/sidra_1378.rds"))
...
m <- tm_shape(resp_bairros) +
  tm_polygons(
    ...
    fill.legend = tm_legend(
      title = "Domicílios chefiados (25 a 39 anos, %)"
    ),
  ...
  tm_view(set_view = c(-51.179152, -30.025976, 13))
