...
ekio_academy_colors <- list(
  ...
  secondary = "#16a085", 
  tertiary = "#138d75",
  sequential = c("#e8f8f5", "#a3e4d7", "#1abc9c", "#16a085", "#138d75", "#0e6b5c", "#0a4f44"),
...
ekio_modern_premium_colors <- list(
  ...
  secondary = "#3c7bc3",
  tertiary = "#1E5F9F",
  sequential = c("#f4f7fb", "#e3ecf5", "#d2e1ef", "#a0bfdb", "#6d9dc7", "#2C6BB3", "#265c9a", "#204d81", "#1a3e68"),
...
theme_ekio <- function(style = "academy_primary", base_size = 12, base_family = "Avenir") {
...
scale_fill_ekio_seq <- function(style = "academy_primary", n = 7, direction = 1, ...) {
...
scale_color_ekio_seq <- function(style = "academy_primary", n = 7, direction = 1, ...) {
...
ekio_choropleth_br <- function(data, fill_var, style = "academy_primary", 
  ...
  ggplot(data) +
    ...
    scale_fill_ekio_seq(style, name = stringr::str_to_title(gsub("_", " ", fill_var))) +
    theme_ekio(style) +
    theme(
